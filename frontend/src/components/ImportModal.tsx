      ...
      >
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4">
          ...
          <div className="rounded-md border border-[var(--accent)]/25 bg-[var(--accent)]/5 px-3 py-2 text-[11px] text-[var(--text-secondary)]">
            ...
            expanded automatically. When copy finishes, the{" "}
            <strong className="text-[var(--text-primary)]">drive auto-ejects</strong> so you can
            insert the next disc — classification continues in the background. Discs copy in series.
            Minimize (Esc) frees the UI.
          </div>
        </div>
